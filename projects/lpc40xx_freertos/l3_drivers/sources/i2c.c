...
static bool i2c__handle_state_machine(i2c_s *i2c) {
  enum {
    ...
    // Slave Receiver States (GC):
    I2C__STATE_GC_SLAVE_ADDR_ACK = 0x70,
    I2C__STATE_GC_SLAVE_ADDR_NACK = 0x78,
    I2C__STATE_GC_SLAVE_DATA_ACK = 0x90,
    I2C__STATE_GC_SLAVE_DATA_NACK = 0x98,
  };
  ...
  case I2C__STATE_ST_SLAVE_DATA_NACK: // 0xC0
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;

  case I2C__STATE_ST_LAST_BYTE: // 0xC8
    break;

    // Slave Receiver States (SR):
  case I2C__STATE_SR_SLAVE_ADDR_ACK: // 0x60
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    i2c->slave_count = 0;
    break;
  ...
  case I2C__STATE_GC_SLAVE_DATA_ACK: // 0x90
    i2c->slave_input_byte_pointer = lpc_i2c->DAT;
    lpc_i2c->CONCLR = 0x0C;
    break;

  case I2C__STATE_SR_STOP: // 0xA0
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;
  ...
  case I2C__STATE_SR_SLAVE_ADDR_NACK: // 0x68
  case I2C__STATE_GC_SLAVE_ADDR_NACK: // 0x78
  case I2C__STATE_SR_SLAVE_DATA_NACK: // 0x88
  case I2C__STATE_GC_SLAVE_DATA_NACK: // 0x98

  case I2C__STATE_ST_SLAVE_READ_NACK: // 0xB0
