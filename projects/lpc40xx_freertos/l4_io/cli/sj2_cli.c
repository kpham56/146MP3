...
void sj2_cli__init(void) {
  ...
  static app_cli__command_s task_control = {.command_name = "taskcontrol",
                                            .help_message_for_command = "lets you control tasks via CLI",
                                            .app_cli_handler = cli__task_control};

  static app_cli__command_s music_control = {
      .command_name = "play", .help_message_for_command = "play foo.mp3", .app_cli_handler = cli__music_control};
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &music_control);
